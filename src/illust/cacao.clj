(ns illust.cacao
  "Agent-side CACAO issuance (JVM) for illust-actor. 1:1 port of the
  ...
  The private key is persisted to `.illust/identity.edn` (gitignored) —
