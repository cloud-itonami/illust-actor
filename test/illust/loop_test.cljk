(ns illust.loop-test
  "Full tick! cycle, fully offline: illust.murakumo/illust.judge/datalad shell
  ...
  (:require [clojure.test :refer [deftest testing is]]
            ...
            [illust.publisher :as publisher]))

(defn- tmp-dir []
  (let [f (java.io.File/createTempFile "illust-loop-test" "")]
    (.delete f) (.mkdirs f) f))
